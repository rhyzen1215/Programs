<?Php
 ...
 include 'DBConnect.php';
	...
	if (isset($_REQUEST['btnApply'])){
		...
		$sql="INSERT INTO LEAVEAPPLICATION(LEAVECOUNT, LEAVEID, EMPLOYEENO, EMPLOYEENAME, LEAVECODE, DATEFROM, DATETO, TIMEFROM, TIMETO) VALUES('$LeaveCount','$LeaveID','$EmpID','$EName','$Leave','$DateFrom','$DateTo','$TimeFrom','$TimeTo')";
		$rs=odbc_exec($conn,$sql);
...
<body>
	...
	<table>
		<tr>
		  ...
		  <td width="110" id="tdID2"><font color="#660000" size="3" face="Century Gothic"><?Php   echo $LeaveID ?></font></td>
		</tr>
	</table>
	...
	<table>
		<tr>
		  ...
		  <td width="250"><input name="EName" type="text" size="30" value="<?Php echo $Name ?>" /></td>
	...
	<table>
		<tr>
		  ...
		  <td width="250"><input type="text" size="30" value="<?Php echo $Position ?>"/></td>
	...
	<table>
		<tr>
		  ...
		  <td width="250"><input type="text" size="30" value="<?Php echo $Rank ?>"/></td>
		  <td width="100" id="tdID2" align="right">Branch/Unit:</td>
		  <td width="150"><input type="text" size="20" value="<?Php echo $Branch ?>" /></td>
		</tr>
	</table>
	...
	<table>
		...
		<tr><td width="69"></td>
		<td id="tdID2"><input name="LeaveType" type="checkbox"  value="LWP"> Leave Without Pay</td>
			<td width="53"></td>
	...
	<table>
		<tr><td id="tdID2">Reason(s): <input type="text" size="50" name="Reason" value="<?php echo $LeaveCount ?>"/></td></tr>
	</table>
	...
	<table>
		<tr>
		  <td width="110" id="tdID2" align="right">Leave Credits:</td>
		  <td width="200"><input type="text" size="10" /></td>
		  <td width="160" id="tdID2" align="right">Recommending Approval:</td>
		  <td width="100"><input type="text" size="21" name="RApproval" /></td>
		</tr>
		<tr>
		  <td width="110" id="tdID2" align="right">Leave Request:</td>
		  <td width="250"><input type="text" size="10" /></td>
		...
		<tr>
		  <td width="110" id="tdID2" align="right">Leave Balance:</td>
		  <td width="250"><input type="text" size="10" /></td>
