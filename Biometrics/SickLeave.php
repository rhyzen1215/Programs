...
<hr size="3" color="#666666" align="left" width="645"/>
	...
	<tr>
		...
		<td><input type="Submit" size="8" name="btnSub" value="Search" onclick="javascript: formSub.action='SickLeave.php'; formSub.method='GET';"/></td>
		<td></td>
		<td></td>
