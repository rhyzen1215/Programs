...
<hr size="3" color="#666666" align="left" width="645"/>
	...
	<tr>
		...
		<td><input type="Submit" size="8" name="btnSub" value="Search" onclick="javascript: formSub.action='LeaveInquiry.php'; formSub.method='POST
		';"/></td>
		<td></td>
		<td></td>
