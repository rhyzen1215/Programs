...
<body background="images/bg2.jpg">
	...
	<div id="container1">
		...
		<div id="TopInfo">
			<table><tr><td>Employee ID Number: <input type="text" size="7" name="empIDNum" value="<?Php echo $empID; ?>" /></td></tr></table>
		</div>
		...
		<div id="leftbody">
			...
			<div id="navID">
				...
				<table width="207" align="left">
				<tr><th width="27"></th>
				<th width="168" align="left"><a href="Education.php" target="iframe3" onclick="disableclick(e)">Educational Details</a></th>
				</tr></table>
				</div>
				...
				<table width="207" align="left">
				<tr><th width="27"></th>
				<th width="168" align="left"><a href="PersonalData.php" target="iframe3" onclick="disableclick(e)">Trainings/Seminars</a></th>
				</tr></table>
				</div>
				<div id="ID1">
				<table width="207" align="left">
				<tr><th width="27"></th>
				<th width="168" align="left"><a href="LeaveInquiry.php" target="iframe3" onclick="disableclick(e)">Leave Details</a></th>
				</tr></table>
				</div>
				<div id="ID1">
				<table width="207" align="left">
				<tr><th width="27"></th>
				<th width="168" align="left"><a href="PersonalData.php" target="iframe3" onclick="disableclick(e)">Schedule Details</a></th>
				</tr></table>
				</div>
