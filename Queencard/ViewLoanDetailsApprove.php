...
<body>
            <?Php
				...
				if ((isset($_REQUEST['btnUpdateAmount'])) || (isset($_REQUEST['btnUpdateAmount']))){
			...
			<td><a id="Amortization" href="Amortization.php?LoanID=<?Php echo $LoanIDnum ?>&AmortDates=true" target="_blank" >View</a></div></td></div></td></tr>
			...
			<td width="137"><select name="AppStatus" style="width:110px">
			 ...
			 <td width="139"><input name="btnUpdateStatus" type="Submit" value="Save" onclick="javascript: frmViewAccount.action='ViewLoanDetailsApproveSave.php';"/><input name="btnComment" type="Button" value="Comment" onclick="NewComment()"/></td></tr>
			 <input name="MUser" id="MUser" type="hidden" value="<?Php echo $Muser ?>" />
