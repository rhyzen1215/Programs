		...
		function Promissory() {
					...
					var LPURPOSE = document.getElementById("LPURPOSE").value;
					...
					var IntCon = IntR * 100;
					IntCon = IntCon.toFixed(4);
					var IntWord = NumberConvert(IntCon);
					var InValue = parseFloat(IntR) * 100;
					InValue = InValue.toFixed(4);
					IntWord = IntWord + " (" + InValue + ")";
					var termDoc = NumberConvert(Trms * 2);
					termDoc = termDoc + " (" + (Trms * 2) + ")";
					
					
					if ((ProdCode =="QSAL") || (ProdCode =="QPBD")) { AmortText = "SEE AMORTIZATION SCHEDULE";}
					else { AmortText = AmortValueTxt;}
					
					var myTExt = "semi-monthly";

					if (payFrequency == "Sei-Monthly") { 
							myTExt = "semi-monthly";
							termDoc = NumberConvert(Trms * 2);
							termDoc = termDoc + " (" + (Trms * 2) + ")";
							}
					else if (payFrequency == "Monthly") { 
							myTExt = "monthly";
							termDoc = NumberConvert(Trms);
							termDoc = termDoc + " (" + Trms + ")";
							}
					...
					newWin.document.write("<label id='underWord'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>");
					...
					newWin.document.write("<table width='300' height='50' cellpadding='50'>");
					newWin.document.write("<tr>");
					newWin.document.write("<td id='UpperBody' ><label id='underWord'>" + BorrowerName.bold() + "</label>");
					newWin.document.write("</td>");
					newWin.document.write("<tr>");
					...
					newWin.document.write("<tr id='UpperBody'><td id='UpperBody' >PURPOSE OF LOAN:</td>");
					newWin.document.write("<td id='bb' width='400'>" + LPURPOSE.bold() + "</td></tr>");
					newWin.document.write("</table>");
