		...
		function Application() {
					...
					var Officer1 = document.getElementById("Officer1").value;
					var Officer2 = document.getElementById("Officer2").value;
					...
					var centum = IntR * 100;
					centum = centum / 12;
					centum = centum.toFixed(2);
					var InterestValue = IntR * 100;
					InterestValue = InterestValue.toFixed(4);
					
					
					
					var LoanAmntValue = DigitConvert(DimAmount);
					...
					DimAmount = parseFloat(DimAmount);
					DimAmount = DimAmount.format(2);
					LoanAmntValue = LoanAmntValue + " (P" + DimAmount + ")";
					...
					if (DATEAPPROVED != "") {
					var appdate = new Date(DATEAPPROVED);
    				var appMonth = month[appdate.getMonth()];
					var appDay = appdate.getDate();
					var appYear = appdate.getFullYear();
					var appDate = appMonth + " " + appDay + ", " + appYear; 
					} else { appDate = ""; }
					...
					newWin.document.write("<td id='UpperBody' width='400'>If not, monthly Rental:" + RENTAL.bold() + "</td>");
					newWin.document.write("</tr>");
					newWin.document.write("</table>");
					...
					newWin.document.write("<table>");
					newWin.document.write("<tr>");
					newWin.document.write("<td id='Queencard' width='150'>Name of Creditor</td>");
					newWin.document.write("<td id='Queencard' width='120'>Amount</td>");
					newWin.document.write("<td id='Queencard' width='120'>Date Granted</td>");
					newWin.document.write("<td id='Queencard' width='120'>Date Mature</td>");
					newWin.document.write("<td id='Queencard' width='120'>Remarks</td>");
					newWin.document.write("</tr>");
					newWin.document.write("</table>");
					
					newWin.document.write("<table>");
					newWin.document.write("<tr>");
					newWin.document.write("<td id='UpperBody' width='150'>QPBD-2015-0013</td>");
					newWin.document.write("<td id='UpperBody' width='120'>2,000,000.00</td>");
					newWin.document.write("<td id='UpperBody' width='120'>6/4/2015</td>");
					newWin.document.write("<td id='UpperBody' width='120'>12/4/2015</td>");
					newWin.document.write("<td id='UpperBody' width='120'>Outstanding</td>");
					newWin.document.write("</tr>");
					
					newWin.document.write("<tr>");
					newWin.document.write("<td id='UpperBody' width='150'>QPBD-2015-0017</td>");
					newWin.document.write("<td id='UpperBody' width='120'>3,700,000.00</td>");
					newWin.document.write("<td id='UpperBody' width='120'>9/30/2015</td>");
					newWin.document.write("<td id='UpperBody' width='120'>3/31/2016</td>");
					newWin.document.write("<td id='UpperBody' width='120'>Outstanding</td>");
					newWin.document.write("</tr>");
					
					newWin.document.write("<tr>");
					newWin.document.write("<td id='UpperBody' width='150'>QPBD-2015-0019</td>");
					newWin.document.write("<td id='UpperBody' width='120'>1,200,000.00</td>");
					newWin.document.write("<td id='UpperBody' width='120'>10/30/2015</td>");
					newWin.document.write("<td id='UpperBody' width='120'>4/31/2016</td>");
					newWin.document.write("<td id='UpperBody' width='120'>Outstanding</td>");
					newWin.document.write("</tr>");
					
					newWin.document.write("<tr>");
					newWin.document.write("<td id='UpperBody' width='150'>QPBD-2015-0020</td>");
					newWin.document.write("<td id='UpperBody' width='120'>1,000,000.00</td>");
					newWin.document.write("<td id='UpperBody' width='120'>11/4/2015</td>");
					newWin.document.write("<td id='UpperBody' width='120'>4/30/2016</td>");
					newWin.document.write("<td id='UpperBody' width='120'>Outstanding</td>");
					newWin.document.write("</tr>");
					newWin.document.write("</table>");
					...
					newWin.document.write("<table>");
					newWin.document.write("<tr><td></td></tr>");
					newWin.document.write("<tr><td id='Queencard' width='350'>Date Approved: <label id='bb'><strong>" + appDate.bold() + "</strong></label></td></tr>");
					...
					newWin.document.write("<table>");
					newWin.document.write("<tr><td width='70'></td>");
					if (Officer1 == "1") {
					newWin.document.write("<td width='130'><img src='images/DAJ1.png' style='width:130px; height: 70px;' /></td>"); }
					else {
					newWin.document.write("<td width='130'><img src='images/DAJ2.png' style='width:130px; height: 70px;' /></td>");
						}
					newWin.document.write("<td width='180'></td>");
					if (Officer2 == "1") {
					newWin.document.write("<td width='130'><img src='images/EOJ1.png' style='width:130px; height: 70px;' /></td></tr>");
						}
					else {
					newWin.document.write("<td width='130'><img src='images/EOJ2.png' style='width:130px; height: 70px;' /></td></tr>");
						}
					newWin.document.write("</table>");
