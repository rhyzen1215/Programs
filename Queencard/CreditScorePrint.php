...
<body>
	...
	<?Php 
	if ($Standing == "FAIL") { 
		echo '<td width="200">Reason:'.$Reason;
		//echo '<table>';
		//echo '<tr><td height="30"></td></tr>';
		//echo '<tr>';
		//echo '<td align="left">Certified Correct:</td>';
		//echo '<td align="left"> ________________ </td>';
		//echo '</tr>';
		//echo '<tr>';
		//echo '<td align="left"></td>';
		//echo '<td align="center">HRG Head</td>';
		//echo '</tr>';
		//echo '</table>';
		echo '</td>';
		}
	...
	echo '<tr><td width="116">&nbsp;</td><td width="572">DIRECTOR</td></tr>';
	echo '</table>';
	}
