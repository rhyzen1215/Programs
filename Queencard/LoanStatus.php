...
<body>
		...
		?>
			<table>
			 <tr> <td align="center"><span class="style8">LOAN STATUS <?Php echo $LoanCompany." (".$ProdName." - ".$LoanStatus.")"; ?></span></td></tr>
				...
				while (odbc_fetch_row($rs))
					{
						...
						echo ('<td width="80"></td>');
						echo ('<td width="80"></td>');
						echo ('<td width="200"><strong><a href="LoanStatusPrint.php?LoanCompany='.$LoanCompany.'&LoanProduct='.$LoanProduct.'&LoanStatus='.$LoanStatus.'" style="text-decoration:none;" target="_blank">Print View</a></strong></td>');
						echo ('<td width="100" align="center"></td>');
						echo ('<td width="100" align="center"></td>');
						echo ('<td width="100" align="center"></td>');
