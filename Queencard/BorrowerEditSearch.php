...
<body>
			...
			<table> 
				...
				<input name="SearchB" id="SearchB" type="submit" value="Search" onclick="javascript: frmSearch.action='BorrowerEditSearch.php'; frmSearch.method='GET';" /></div></td>
                <td></td>
  				</tr>
				</form>	
             </table>
			...
			include 'connect.php';
			 ...
			 if (isset($_GET['SearchBor'])){
				...
				while (odbc_fetch_row($rs))
					{
						echo ('<form name="SubSearch" action="BorrowerEdit.php">');
						echo ('<tr>');
						echo ('<td width="50"></td>');
