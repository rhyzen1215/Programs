	<?Php
		...
		if (isset($_REQUEST['btnSubmit'])){
			...
			if ($BORChck == "1") {
				...
				$sql = "Update Evaluation set MPLPro='".$MPLPro."',MPLCon='".$MPLCon."',TMDRPro='".$TMDRPro."',TMDRCon='".$TMDRCon."',PREVPro='".$PREVPro."',PREVCon='".$PREVCon."',EMPAPPPro='".$EMPAPPPro."',EMPAPPCon='".$EMPAPPCon."',EMPSPro='".$EMPSPro."',EMPSCon='".$EMPSCon."',CHECKPro1='".$CHECKPro1."',CHECKPro2='".$CHECKPro2."',CHECKCon1='".$CHECKCon1."',CHECKCon2='".$CHECKCon2."',CASAPro1='".$CASAPro1."',CASAPro2='".$CASAPro2."',CASACon='".$CASACon."', MPL='".$MPL."', TMDR='".$TMDR."', PREV='".$PREV."', EMP='".$EMP."', EMPS='".$EMPS."', CHECKING='".$CHECKING."', CASA='".$CASA."' where borrowerno = '".$BorrID."'";
				$rs=odbc_exec($conn,$sql) or die("Error in query");	
			}
			else {
				
				$sql = "Insert Into Evaluation(borrowerno, MPLPro, MPLCon, TMDRPro, TMDRCon, PREVPro, PREVCon, EMPAPPPro, EMPAPPCon, EMPSPro, EMPSCon, CHECKPro1, CHECKPro2, CHECKCon1, CHECKCon2, CASAPro1, CASAPro2, CASACon, MPL, TMDR, PREV, EMP, EMPS, CHECKING, CASA) Values('$BorrID', '$MPLPro', '$MPLCon',  '$TMDRPro', '$TMDRCon', '$PREVPro', '$PREVCon', '$EMPAPPPro', '$EMPAPPCon', '$EMPSPro', '$EMPSCon', '$CHECKPro1', '$CHECKPro2', '$CHECKCon1', '$CHECKCon2', '$CASAPro1', '$CASAPro2', '$CASACon', '$MPL', '$TMDR', '$PREV', '$EMP', '$EMPS', '$CHECKING', '$CASA')";
				$rs=odbc_exec($conn,$sql) or die("Error in query");
		...
		$AmountLoan = number_format($Amount,2,'.',',');
...
<body>
	...
	<td id="td1" width="276"><input type="text" size="15"  name="empname" value="<?Php echo $AmountLoan; ?>" readonly="readonly" style="border:none"/>
	...
	<td id="td1" width="154"><input type="text" size="10"  name="date" value="<?Php echo $MonthlyAmort1; ?>" readonly="readonly" style="border:none"/></td>
	</tr></table>
	...
	<table width="700" id="td2">
	<tr>
	<td width="300">EVALUATION PROCESS</td>
	<td width="142">PRO</td>
	<td width="131">CON</td>
	<td width="107" align="center">REMARKS</td>
	</tr>
	</table>
	
	<table width="700">
	<tr>
	<td width="299">MPL versus TMFDI (75%)</td>
	<td width="143">[ <?Php if ($MPLPro == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] w/in standard</td>
	<td width="129">[ <?Php if ($MPLCon == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] not within</td>
	<td width="109" align="center"><?Php echo $MPL; ?></td>
	</tr>
	<tr>
	<td width="299">TMDR versus TMFI (55%)</td>
	<td width="143">[ <?Php if ($TMDRPro == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] w/in standard</td>
	<td width="129">[ <?Php if ($TMDRCon == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] not within</td>
	<td width="109" align="center"><?Php echo $TMDR; ?></td>
	</tr>
	<tr>
	<td width="299">Previous Experience with Queenbank</td>
	<td width="143">[ <?Php if ($PREVPro == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] satisfactory</td>
	<td width="129">[ <?Php if ($PREVCon == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] not satisfactory</td>
	<td width="109" align="center"><?Php echo $PREV; ?></td>
	</tr>
	<tr>
	<td width="299">Employment of Applicant/Co-borrower</td>
	<td width="143">[ <?Php if ($EMPAPPPro == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] stable</td>
	<td width="129">[ <?Php if ($EMPAPPCon == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] unstable</td>
	<td width="109" align="center"><?Php echo $EMP; ?></td>
	</tr>
	<tr>
	<td width="299">Employment of Spouse</td>
	<td width="143">[ <?Php if ($EMPSPro == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] stable</td>
	<td width="129">[ <?Php if ($EMPSCon == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] unstable</td>
	<td width="109" align="center"><?Php echo $EMPS; ?></td>
	</tr>
	<tr>
	<td width="299">Checkings (applicant/co-borrower)</td>
	<td width="143">[ <?Php if ($CHECKPro1 == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] favorable</td>
	<td width="129">[ <?Php if ($CHECKCon1 == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] unfavorable</td>
	<td width="109" align="center"><?Php echo $CHECKING; ?></td>
	</tr>
	<tr>
	<td width="299">&nbsp;</td>
	<td width="143">[ <?Php if ($CHECKPro2 == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] mixed</td>
	<td width="129">[ <?Php if ($CHECKCon2 == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] sued</td>
	<td width="109">&nbsp;</td>
	</tr>
	<tr>
	<td width="299">CASA with other Banks</td>
	<td width="143">[ <?Php if ($CASAPro1 == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] handled well</td>
	<td width="129">[ <?Php if ($CASACon == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] fairly handled</td>
	<td width="109" align="center"><?Php echo $CASA; ?></td>
	</tr>
	<tr>
	<td width="299">&nbsp;</td>
	<td width="143">[ <?Php if ($CASAPro2 == 1) { echo '&#10004;';} else { echo "&nbsp;&nbsp;&nbsp;";} ?> ] closed due to</td>
	<td width="129">poor handling</td>
	...
	<tr>
	<td width="89">&nbsp;</td>
	<td width="599">Monthly amortization of P<?Php echo $MonthlyAmort; ?> payable every semi-monthly/monthly/quarterly for the </td>
	</tr>
	<tr>
	<td width="89">&nbsp;</td>
    ...
    <?Php if ($DevStat == 1) {
    	...
    	//echo '<table>';
        //echo '<tr>';
        //echo '<td>Certified Correct: </td>';
        //echo '<td>___________________</td>';
        //echo '</tr>';
        //echo '<tr><td></td>';
        //echo '<td align="center">HRG Head</td></tr>';
        //echo ' </table>';
     ...
     ?>  
        <table>
        <tr><td><?Php if ($DevStat == 1) { echo "<strong>Deviation:</strong> "."<i>".$Deviation."</i>"; } ?></td></tr>
    	</table>
    
    </td>
	<td width="268" align="center"><img src="images/gretchen2.jpg" width="210" height="80" /></td>
	</tr>
	</table>
    ...
    <?php
		if ($DevStat == 0) {
			if ($Off2 == 1) { echo '<img src="images/DAJ_1.jpg" width="165" height="65"/>'; }
			else { echo '<img src="images/DAJ_0.jpg" width="165" height="65"/>'; }
		}
		else if ($DevStat == 1) {
			echo '<img src="images/MRCF.jpg" width="200" height="80"/>'; 
		}
	?>
    </td>
	<td width="72">&nbsp;</td>
    ...
    <?php
		if ($DevStat == 0) {
			if ($Off1 == 1) { echo '<img src="images/EOJ_1.jpg" width="165" height="65"/>'; }
			else { echo '<img src="images/EOJ_0.jpg" width="165" height="65"/>'; }
		}
	?>
    </td>
	<td width="54">&nbsp;</td>
