		...
		function ADA() {
					...
					var BorrowerName = document.getElementById("FORMATNAME").value;
					...
					var DATEMATURE = document.getElementById("DATEMATURE").value;
					...
					var dMature = new Date(DATEMATURE);
    				var DMonth = (dMature.getMonth() + 1);
					var DDay = dMature.getDate();
					var DYear = dMature.getFullYear();
					...
					if (ProdCode != "QSAL") { DimAmort = parseFloat(AmortValue); }
					DimAmort = DimAmort.toFixed(2);
					
					var DimAmortText = "  PHP " +  DimAmort + "  ";
					...
					if (payFrequency == "Semi-Monthly") { dteCheck = dt1Val + " and " + dt2Val; }
					else if (payFrequency == "Monthly") { dteCheck = dt2Val; }
					...
					if (payFrequency == "Semi-Monthly") { MonthlyInstall = MonthlyInstall / 2; }
					...
					newWin.document.write("<label id='underWord'>  PHP " + MonthlyInstall.bold() + "  </label>");
					newWin.document.write("  to be debited on or before _____________ of the month commencing on  ");
					newWin.document.write("<label> ________________ </label>");
					...
					newWin.document.write("<table>");
					newWin.document.write("<tr><td width='600' height='10' align='left'></td></tr>");
					newWin.document.write("<tr id='UpperBody2'><td id='UpperBody2' width='600'><p id='pIndent'> b. Amount of PHP <label id='underWord'>  " + LoanAmt.bold() + "  </label>  to be debited on or before <label id='underWord'>  " + DDate.bold() + "  </label>.</p></td></tr>");
					newWin.document.write("<tr id='UpperBody'><td id='UpperBody' width='600' align='center'></td></tr>");
					newWin.document.write("</table>");
					
					newWin.document.write("<table>");
					newWin.document.write("<tr><td width='600' height='10' align='left'></td></tr>");
					newWin.document.write("<tr id='UpperBody2'><td id='UpperBody2' width='600'><p id='pIndent'> c. Amount of PHP _____________ (which excludes past due charges in accordance with my statement of account) be debited after the said due date in view of the fact that the available balance of the deposit is not sufficient to cover the net monthly amortization or obligation(s) when due.</p></td></tr>");
					newWin.document.write("<tr id='UpperBody'><td id='UpperBody' width='600' align='center'></td></tr>");
					newWin.document.write("</table>");
					}
					else {
					...
					newWin.document.write("<table>");
					newWin.document.write("<tr><td width='600' height='10' align='left'></td></tr>");
					newWin.document.write("<tr id='UpperBody2'><td id='UpperBody2' width='600'><p>I/We hereby authorize either <label id='underWord'>" + ComName.bold() + "</label> or QUEENCARD CORPORATION any of their dully authorized representative(s) to conduct the necessary inquiry and /or examination of my <label id='underWord'><strong> PAYROLL ACCOUNT </strong></label> account for the purpose affecting the implementation of this automatic debit authorization/arrangement.</p></td></tr>");
					newWin.document.write("<tr id='UpperBody'><td id='UpperBody' width='600' align='center'></td></tr>");
					newWin.document.write("</table>");
