...
<table width="370" cellpadding="0" cellspacing="0">
            ...
            <tr height="15">
             ...
             <table width="667" border="0">
               <tr>
                 <th width="112"> </th>
                 <th width="539"> <div align="left">
                 
                 <?php
	
				$target_dir = $_FILES["File1"]["name"];	
			     $target_dir = "C:\\xampp\\htdocs\\Sample\\".$target_dir;
				 
				$target = fopen($target_dir, "r") or die("Unable to open file!");
				
				while(!feof($target)) 
						{ 
	    			echo fgets($target) . "<br />";
					$target1 = "123456";
					echo base64_encode($target1) . "<br />";
						}
				...
				echo '<input type="text" name="Text1" value ="'.$target_dir.'" size="30" />';
        		$uploadOk = 0;	
               ...
               <input type='submit' value='Process' name='Process' onclick="javascript: form.action='processDTRUpload2.php'; form.method='GET';" />
               <input type="submit" value="Refresh" name="Refresh" onclick="javascript: form.action='processDTRFetch.php'; form.method='POST';" />
                 </div></th>
               </tr>
               
               <tr>
                 <th width="112" height="53"> </th>
                 <th width="539"> <div align="left">
