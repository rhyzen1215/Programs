...
<body>
			...
			<?Php
				$LoanIDnum = "";
				if ((isset($_REQUEST['EditLoan'])) || (isset($_REQUEST['btnUpdateBal'])) || (isset($_REQUEST['btnCheck'])) || (isset($_REQUEST['btnUpdateAmount']))){
			...
			<td><input type="text" name="EIRSample" id="EIRSample" size = "15" value="<?Php echo $EIR." %"; ?>" />
			...
			<td><input type="date" name="BorrowNo" id="" value="<?Php echo $DateApplied ?>" /></td>
