		...
		function Disclosure3() {
					...
					if (DeductM == "Deducted"){
						SCharge1 = SCharge;
						ProcFee1 = parseFloat(ProcFee);
						FCharge1 = FCharges;
						DocStamp1 = DocStamp;
						NotFee1 = NotFee;
						NetPro = parseFloat(LoanAmt) - parseFloat(TCharge);
						APL1 = APL;
						}
					else if (DeductM == "Not deducted"){
						SCharge2 = SCharge; 
						ProcFee2 = parseFloat(ProcFee);
						FCharge2 = FCharges;
						DocStamp2 = DocStamp;
						NotFee2 = NotFee;
					...
					newWin.document.write("<td id='bb' align='left'>" + BorrowerName2.bold() + "</td></tr>");
					...
					newWin.document.write("<td id='UpperBody' align='center' width='20'></td>");
					newWin.document.write("<td id='bb' align='center' width='80'>" + FCharges.bold() + "</td></tr>");
					newWin.document.write("</table>");
					...
					newWin.document.write("<td id='UpperBody' align='center' width='20'></td>");
					if (NSCharge > 0 ){
						newWin.document.write("<td id='bb' align='center' width='80'>" + NSCharge.bold() + "</td></tr>");
						}
					else {
						newWin.document.write("<td id='bb' align='center' width='80'></td></tr>");
						}
					newWin.document.write("</table>");
					...
					newWin.document.write("<td id='bb' align='center' width='80'>" + TCharge.bold() + "</td></tr>");
					newWin.document.write("</table>");
					...
					newWin.document.write("<td id='UpperBody' align='center' width='80'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='40'></td>");
					newWin.document.write("<td id='bb' align='center' width='80'>" + NetPro.bold() + "</td></tr>");
					newWin.document.write("</table>");
					...
					newWin.document.write("<td id='UpperBody' align='left' width='80'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='20'></td>");
					newWin.document.write("<td id='bb' align='center' width='80'>" + DimAmort + "</td>");
					newWin.document.write("<td id='UpperBody' align='center' width='20'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='80'></td></tr>");
					newWin.document.write("</table>");
					...
					newWin.document.write("<table>");
					newWin.document.write("<tr><td id='UpperBody' align='left' width='60'></td>");
					newWin.document.write("<td id='UpperBody' align='left'width='303'><span id='bb' width='15'><strong>24 % </strong></span> per annum penalty charge on all past due accounts</td>");
					newWin.document.write("<td id='UpperBody' align='left' width='70'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='30'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='80'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='20'></td>");
					...
					newWin.document.write("<td id='UpperBody' align='left' width='70'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='30'></td>");
					newWin.document.write("<td id='bb' align='center'>" + BorrowerName2.bold() + "</td></tr>");
					newWin.document.write("<tr><td id='UpperBody' align='left' width='60'></td>");
					newWin.document.write("<td id='UpperBody' align='left'width='303'></td>");
					newWin.document.write("<td id='UpperBody' align='left' width='70'></td>");
					newWin.document.write("<td id='UpperBody' align='center' width='30'></td>");
					newWin.document.write("<td id='UpperBody' align='center'>CERTIFIED CORRECT</td></tr>");
					newWin.document.write("</table>");
