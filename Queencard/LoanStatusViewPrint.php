...
<body>
			...
			<table>
			 <tr> <td align="center"><span class="style8">LOAN STATUS</span></td></tr>
			...
			echo '<select name="LoanCompany" style="width:110px">';
            ...
            <tr>
            <td></td>
            <td align="right"><input type="submit" value="View" name="ViewLoan2" onclick="javascript: frmLoanView.action='LoanStatus.php'; frmLoanView.method='GET';" />
            </td></tr>
			</table>
